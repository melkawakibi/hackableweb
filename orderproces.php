<?php
	...
	$order = $db->run_query_find_one("SELECT * FROM orders where customerid='$customer->id'");
	...
	while($c = $cart->fetch_assoc()){
		...
		$db->run_query_insert("INSERT INTO orderdetail (productid, orderid, amount) VALUES ('$product->id', '$order->id', '$product_ammount')");
